...
'Healthorflow' 서비스를 사용하게 된다면,
	...
	1) '환자'는 긴 대기시간을 기다릴 필요 없이 자신의 증상을 자유롭게 서술하면 예약까지 자동으로 이루어지고,
	   진료시간동안 효율적으로 필요한 질문들을 할 수 있게됩니다.
	2) '의사'는 공통된 질문을 안해도 되니 좀 더 환자에게 집중할 수 있을 것이며, 이는 진료만족도 증가로 이어질 것입니다.
...
'Healthorflow' 서비스는 삼성서울병원에서 Pilot Test를 완료하였고, 큰 관심을 보여주시는 교수님과 함께 커뮤니케이션하며 실제 병원 적용을 계획중에 있습니다.

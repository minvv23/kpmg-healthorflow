...
기술 시연을 위한 UI를 범용성과 생산성이 가장 높은 웹앱으로 구현하였습니다. 신속하고 신뢰성 있는 개발을 위해 입증된 범용 프레임워크인 jQuery와 Bootstrap v4.0을 조합하였습니다. 반응형 UI 개발로 모바일과 PC, 태블릿 환경에서 모두 테스트 가능한 범용성을 확보하였습니다. 향후 사업 확장 시에 모든 스마트폰이나 태블릿의 네이티브 환경에서 사용될 수 있도록 react native로 구현할 계획입니다.  
